...
public class MoveHandOld : MonoBehaviour
{
    [Header("スピード")]
    ...
    private Vector3 m_EndPointPos = Vector3.zero;
    ...
    void Start()
    {
        ...
        m_EndPointPos = new Vector3(MyTrans.position.x, MyTrans.position.y, m_EndObj.transform.position.z);
    }
    ...
    private void MoveMain()
    {
        ...
        if (MyTrans.position.z <= m_EndObj.transform.position.z)
        {
            isActive = false;
        }
    }
